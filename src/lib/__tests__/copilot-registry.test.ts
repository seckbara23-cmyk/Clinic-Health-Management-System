...
const REQUIRED_PACKS = [
  ...
  'dentistry.core', 'nursing.core', 'midwifery.core',
]
...
describe('Copilot Pack Registry — integrity', () => {
  ...
  it('placeholder cores are METADATA ONLY (empty future*); the shipped copilots are populated', () => {
    // Phases 16-27 populated GP / pediatrics / obstetrics / ENT / cardiology /
    // emergency / internal-medicine / orthopedics / ophthalmology / psychiatry cores.
    const REAL = new Set(['general_practice.core', 'pediatrics.core', 'obstetrics.core', 'ent.core', 'cardiology.core', 'emergency.core', 'internal_medicine.core', 'orthopedics.core', 'ophthalmology.core', 'psychiatry.core'])
  ...
  it('lookups never throw', () => {
    ...
    expect(activePacks().length).toBe(16)
  })
})
