...
const REQUIRED_PACKS = [
  ...
  'pulmonology.core', 'nephrology.core', 'oncology.core', 'surgery.core', 'neurology.core', 'endocrinology.core', 'dermatology.core', 'urology.core', 'gastroenterology.core', 'dentistry.core', 'nursing.core', 'midwifery.core',
]
...
describe('Copilot Pack Registry — integrity', () => {
  ...
  it('placeholder cores are METADATA ONLY (empty future*); the shipped copilots are populated', () => {
    // Phases 16-36 populated GP / pediatrics / obstetrics / ENT / cardiology / emergency /
    // internal-medicine / orthopedics / ophthalmology / psychiatry / pulmonology / nephrology / oncology / general-surgery / neurology / endocrinology / dermatology / urology / gastroenterology.
  ...
  it('lookups never throw', () => {
    ...
    expect(activePacks().length).toBe(25)
  })
})
