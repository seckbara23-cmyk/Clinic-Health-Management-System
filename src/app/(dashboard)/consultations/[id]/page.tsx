...
import { InternalMedicineCopilot } from '@/components/consultations/InternalMedicineCopilot'
...
import { NephrologyCopilot } from '@/components/consultations/NephrologyCopilot'
          ...
          <div className="grid grid-cols-1 gap-4 md:gap-6 lg:grid-cols-3">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <EmergencyCopilot
                ...
                invoices={patientInvoices}
              />
              {/* Internal Medicine Clinical Copilot — read-only + chronic-care tracking.
                  Renders only for an internal-medicine doctor with AI enabled. */}
              <InternalMedicineCopilot
                patientId={consultation.patient_id}
                consultation={{ id, created_at: consultation.created_at }}
                patient={{ allergies }}
                doc={{
                ...
                invoices={patientInvoices}
              />
              {/* Orthopedics Clinical Copilot — read-only + musculoskeletal tracking.
                  Renders only for an orthopedics doctor with AI enabled. */}
              <OrthopedicsCopilot
                patientId={consultation.patient_id}
                consultation={{ id, created_at: consultation.created_at }}
                patient={{ allergies }}
                ...
                invoices={patientInvoices}
              />
              {/* Ophthalmology Clinical Copilot — read-only + eye-care tracking.
                  Renders only for an ophthalmology doctor with AI enabled. */}
              <OphthalmologyCopilot
                patientId={consultation.patient_id}
                consultation={{ id, created_at: consultation.created_at }}
                patient={{ allergies }}
                doc={{
              ...
              <PulmonologyCopilot
                ...
                invoices={patientInvoices}
              />
              {/* Nephrology Clinical Copilot — read-only + kidney-care workflow.
                  Renders only for a nephrology doctor with AI enabled. */}
              <NephrologyCopilot
                patientId={consultation.patient_id}
                consultation={{ id, created_at: consultation.created_at }}
                patient={{ allergies }}
                ...
                invoices={patientInvoices}
              />
              {/* Oncology Clinical Copilot — read-only + cancer-care workflow.
                  Renders only for an oncology doctor with AI enabled. */}
              <OncologyCopilot
                patientId={consultation.patient_id}
                consultation={{ id, created_at: consultation.created_at }}
                patient={{ allergies }}
                ...
                invoices={patientInvoices}
              />
              {/* General Surgery Clinical Copilot — read-only + surgical workflow.
                  Renders only for a (general) surgery doctor with AI enabled. */}
              <SurgeryCopilot
                patientId={consultation.patient_id}
                consultation={{ id, created_at: consultation.created_at }}
                patient={{ allergies }}
              ...
              <EndocrinologyCopilot
                ...
                invoices={patientInvoices}
              />
              {/* Dermatology Clinical Copilot — read-only + dermatology workflow.
                  Renders only for a dermatology doctor with AI enabled. */}
              <DermatologyCopilot
                patientId={consultation.patient_id}
                consultation={{ id, created_at: consultation.created_at }}
                patient={{ allergies }}
                ...
                invoices={patientInvoices}
              />
              {/* Urology Clinical Copilot — read-only + urology workflow.
                  Renders only for a urology doctor with AI enabled. */}
              <UrologyCopilot
                patientId={consultation.patient_id}
                consultation={{ id, created_at: consultation.created_at }}
                patient={{ allergies }}
